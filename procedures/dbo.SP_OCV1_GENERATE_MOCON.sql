	...
	BEGIN
		...
		BEGIN TRY
			...
			BEGIN
				...
				SET @WCD_IDVENDA = (SELECT TOP 1 CD_IDVENDA FROM #LANCAMENTOS)
				
				SELECT @VL_TOTALVE = SUM(VL_TOTVEND) FROM #LANCAMENTOS WHERE CD_IDVENDA = @WCD_IDVENDA
				...
				VALUES(@WCD_IDVENDA, @WCD_CLIENTE, ROUND(@VL_TOTALVE, 2), @WDT_FATURAM, @WDT_ENTREGA)
